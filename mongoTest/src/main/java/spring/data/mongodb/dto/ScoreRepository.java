...
//                    (기본CRUD와 paging처리, sort기능을 지원)      (기본CRUD기능)
//mongodb에 저장되어 있는 컬렉션의 데이터를 액세스할 수 있는 기능을 
//프레임워크 내부에서 지원하며 컬렉션 내부의 데이터를 자동으로 저장할 repository
public interface ScoreRepository extends PagingAndSortingRepository<ScoreDTO, String>{//String=_id타입

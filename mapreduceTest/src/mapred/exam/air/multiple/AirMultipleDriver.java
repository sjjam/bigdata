...
public class AirMultipleDriver extends Configured implements Tool{
	...
	public int run(String[] optionlist) throws Exception {
		...
		MultipleOutputs.addNamedOutput(job, "dNA", TextOutputFormat.class, Text.class, IntWritable.class);
		MultipleOutputs.addNamedOutput(job, "aNA", TextOutputFormat.class, Text.class, IntWritable.class);
